    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <?php if ($playerModel->role == 'merlin'): ?>
                <p><img src="images/merlin.jpg" class="role-img"/></p>
                <ul>
            ...
            <?php if ($playerModel->role == 'percival'): ?>
                <p><img src="images/percival.jpg" class="role-img"/></p>
                <ul>
            ...
            <?php if ($playerModel->role == 'servant'): ?>
                <p><img src="images/servant.jpg" class="role-img"/></p>
                <ul>
            ...
            <?php if ($playerModel->role == 'assassin'): ?>
                <p><img src="images/assassin.jpg" class="role-img"/></p>
                <ul>
            ...
            <?php if ($playerModel->role == 'mordred'): ?>
                <p><img src="images/mordred.jpg" class="role-img"/></p>
                <ul>
                    <li>You need to work with the other <?= $textMinions ?></li>
            ...
            <?php if ($playerModel->role == 'morgana'): ?>
                <p><img src="images/morgana.jpg" class="role-img"/></p>
                <ul>
                    <li>You need to work with the other <?= $textMinions ?></li>
                    <li><?= $textMinions ?> should try to fail quests</li>
            ...
            <?php if ($playerModel->role == 'minion'): ?>
                <p><img src="images/minion.jpg" class="role-img"/></p>
                <ul>
                    <li>You need to work with the other <?= $textMinions ?></li>
                    <li><?= $textMinions ?> should try to fail quests</li>
                </ul>
            ...
            <?php if ($playerModel->role == 'oberon'): ?>
                <p><img src="images/oberon.jpg" class="role-img"/></p>
                <ul>
                    <li>You need to work with the other <?= $textMinions ?></li>
                    <li><?= $textMinions ?> should try to fail quests</li>
